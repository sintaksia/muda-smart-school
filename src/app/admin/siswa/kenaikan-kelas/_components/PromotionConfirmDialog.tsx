  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-lg sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Jalankan Kenaikan Kelas</DialogTitle>
          <DialogDescription>
            {totalStudents} siswa akan dipindahkan dari {fromAcademicYear} ke{" "}
            {toAcademicYear}. Siswa yang lulus dan keluar dilepas dari{" "}
            {ENTITY_LABELS.CLASS.toLowerCase()}nya. Tahun ajaran aktif ikut
            berpindah ke {toAcademicYear}.
          </DialogDescription>
        </DialogHeader>
