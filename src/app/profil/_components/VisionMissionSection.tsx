  ...
  return (
    <section className="py-12 md:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="bg-gradient-to-r from-primary-900 to-primary-800 rounded-lg p-6 md:p-8 mb-8">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-yellow-400 rounded-sm flex items-center justify-center flex-shrink-0">
              <svg
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {misiList.map((misi, index) => (
              <div
                key={index}
                className="flex items-start gap-3 bg-neutral-50 rounded-md p-3 border border-neutral-200"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              {prestasiList.map((prestasi) => (
                <div
                  key={prestasi.id}
                  className="bg-white rounded-md p-4 border border-neutral-200 hover:border-primary-300 transition-colors"
                >
